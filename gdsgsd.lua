...
function Library:Window(options)
	...
	if options.ChatSpy then
		do
			-- StarterGui.MyLibrary.ChatSpy
			GUI["z2"] = Instance.new("Frame", GUI["1"]);
			GUI["z2"]["BorderSizePixel"] = 0;
			GUI["z2"]["BackgroundColor3"] = Color3.fromRGB(31, 31, 31);
			GUI["z2"]["Size"] = UDim2.new(0, 400, 0, 30);
			GUI["z2"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["z2"]["Position"] = UDim2.new(0.0074850465171039104, 0, 0.3721804618835449, 0);
			GUI["z2"]["Name"] = [[ChatSpy]];

			-- StarterGui.MyLibrary.ChatSpy.Bar
			GUI["z3"] = Instance.new("Frame", GUI["z2"]);
			GUI["z3"]["BorderSizePixel"] = 0;
			GUI["z3"]["BackgroundColor3"] = Color3.fromRGB(0, 255, 0);
			GUI["z3"]["Size"] = UDim2.new(1, 0, 0, 3);
			GUI["z3"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["z3"]["Name"] = [[Bar]];

			-- StarterGui.MyLibrary.ChatSpy.DropShadowHolder
			GUI["z4"] = Instance.new("Frame", GUI["z2"]);
			GUI["z4"]["ZIndex"] = 0;
			GUI["z4"]["BorderSizePixel"] = 0;
			GUI["z4"]["BackgroundTransparency"] = 1;
			GUI["z4"]["Size"] = UDim2.new(1, 0, 1, 0);
			GUI["z4"]["Name"] = [[DropShadowHolder]];

			-- StarterGui.MyLibrary.ChatSpy.DropShadowHolder.DropShadow
			GUI["z5"] = Instance.new("ImageLabel", GUI["z4"]);
			GUI["z5"]["ZIndex"] = 0;
			GUI["z5"]["BorderSizePixel"] = 0;
			GUI["z5"]["SliceCenter"] = Rect.new(49, 49, 450, 450);
			GUI["z5"]["ScaleType"] = Enum.ScaleType.Slice;
			GUI["z5"]["ImageColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["z5"]["ImageTransparency"] = 0.5;
			GUI["z5"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
			GUI["z5"]["Image"] = [[rbxassetid://6014261993]];
			GUI["z5"]["Size"] = UDim2.new(1, 30, 1, 30);
			GUI["z5"]["Name"] = [[DropShadow]];
			GUI["z5"]["BackgroundTransparency"] = 1;
			GUI["z5"]["Position"] = UDim2.new(0.5, 0, 0.5, 0);

			-- StarterGui.MyLibrary.ChatSpy.Title
			GUI["z6"] = Instance.new("TextLabel", GUI["z2"]);
			GUI["z6"]["BorderSizePixel"] = 0;
			GUI["z6"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
			GUI["z6"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Normal);
			GUI["z6"]["TextSize"] = 14;
			GUI["z6"]["TextColor3"] = Color3.fromRGB(215, 215, 215);
			GUI["z6"]["Size"] = UDim2.new(1, 0, 1, -3);
			GUI["z6"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["z6"]["Text"] = [[Chat Spy]];
			GUI["z6"]["Name"] = [[Title]];
			GUI["z6"]["BackgroundTransparency"] = 1;
			GUI["z6"]["Position"] = UDim2.new(0, 0, 0, 3);

			-- StarterGui.MyLibrary.ChatSpy.UIStroke
			GUI["z7"] = Instance.new("UIStroke", GUI["z2"]);
			GUI["z7"]["Color"] = Color3.fromRGB(21, 21, 21);

			-- StarterGui.MyLibrary.ChatSpy.ContentContainer
			GUI["z8"] = Instance.new("ScrollingFrame", GUI["z2"]);
			GUI["z8"]["Active"] = true;
			GUI["z8"]["BorderSizePixel"] = 0;
			GUI["z8"]["BackgroundColor3"] = Color3.fromRGB(21, 21, 21);
			GUI["z8"]["Size"] = UDim2.new(1, 0, 0, 150);
			GUI["z8"]["ScrollBarImageColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["z8"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["z8"]["Position"] = UDim2.new(0, 0, 1, 0);
			GUI["z8"]["Name"] = [[ContentContainer]];

			-- StarterGui.MyLibrary.ChatSpy.ContentContainer.ChatFrame
			GUI["z9"] = Instance.new("Frame", GUI["z8"]);
			GUI["z9"]["BorderSizePixel"] = 0;
			GUI["z9"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
			GUI["z9"]["BackgroundTransparency"] = 1;
			GUI["z9"]["Size"] = UDim2.new(1, 0, 0, 20);
			GUI["z9"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["z9"]["Name"] = [[ChatFrame]];

			-- StarterGui.MyLibrary.ChatSpy.ContentContainer.ChatFrame.Chat
			GUI["za"] = Instance.new("TextLabel", GUI["z9"]);
			GUI["za"]["BorderSizePixel"] = 0;
			GUI["za"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
			GUI["za"]["TextXAlignment"] = Enum.TextXAlignment.Left;
			GUI["za"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			GUI["za"]["TextSize"] = 14;
			GUI["za"]["TextColor3"] = Color3.fromRGB(255, 255, 255);
			GUI["za"]["Size"] = UDim2.new(1, 0, 1, 0);
			GUI["za"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
			GUI["za"]["Text"] = [[[@ase]: 1234]];
			GUI["za"]["Name"] = [[Chat]];
			GUI["za"]["BackgroundTransparency"] = 1;

			-- StarterGui.MyLibrary.ChatSpy.ContentContainer.ChatFrame.Chat.UIPadding
			GUI["zb"] = Instance.new("UIPadding", GUI["za"]);
			GUI["zb"]["PaddingBottom"] = UDim.new(0, 2);
			GUI["zb"]["PaddingLeft"] = UDim.new(0, 7);

			-- StarterGui.MyLibrary.ChatSpy.ContentContainer.UIStroke
			GUI["zc"] = Instance.new("UIStroke", GUI["z8"]);
			GUI["zc"]["Color"] = Color3.fromRGB(21, 21, 21);

			-- StarterGui.MyLibrary.ChatSpy.ContentContainer.UIListLayout
			GUI["zd"] = Instance.new("UIListLayout", GUI["z8"]);
			GUI["zd"]["SortOrder"] = Enum.SortOrder.LayoutOrder;
		end
		...
		function GUI:onChatted(p,msg)
			if _G.chatSpyInstance == instance then
				if p ~= players.LocalPlayer then
					msg = msg:gsub("[\n\r]",''):gsub("\t",' '):gsub("[ ]+",' ')
					local hidden = true
					local conn = getmsg.OnClientEvent:Connect(function(packet,channel)
						if packet.SpeakerUserId==p.UserId and packet.Message==msg:sub(#msg-#packet.Message+1) and (channel=="All") then
							hidden = false
							print("test")
						end
					end)
					...
					function Toggle:Keybind(options)
						...
						function Keybind:Toggle(b)
							if Toggle:GetState() then
								...
								if Keybind.Mode ~= "Off Hold" and Keybind.Mode ~= "Always" then
...
local Main = Library:Window({Name = "LuckyHub", Side = "Center", KeybindList = true, Watermark = true, Indicators = true, VelocityStats = true})

local MainTab = Main:CreateTab({Name = "Main", Icon = "rbxassetid://16863175349", GunList = true})
--
MainTab:CreateGunButton({Name = "Double Barrel", Icon = "rbxassetid://17523930681"})
MainTab:CreateGunButton({Name = "Revolver", Icon = "rbxassetid://17541827331"})
MainTab:CreateGunButton({Name = "Tactical Shotgun", Icon = "rbxassetid://17549286546"})
MainTab:CreateGunButton({Name = "Shotgun", Icon = "rbxassetid://17549285301"})
MainTab:CreateGunButton({Name = "LMG", Icon = "rbxassetid://17541824302"})
--
...
local Section3 = MainTab:Section({Side = "Right"})
local Section2 = MainTab:Section({Side = "Right"})

local Button = Section:Button()
local Label = Section:Label()
Label:ColorPicker()
local Toggle = Section:Toggle({Callback = function(State)
	print(State)
end})
Toggle:Keybind({Default = "Q"})

local Toggle = Section:Toggle()
Toggle:ColorPicker({Callback = function(State)
	print(State)
end})

Section:Slider({Decimal = 0.1, Callback = function(State)
	print(State)
end})

Section:TextBox({Flag = "Test2", Callback = function(v)
	print(v)
end})
